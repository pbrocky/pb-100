...
------------------------------------------ */
	var dumpHTML = function(){
		...
		html += '&lt;style type="text/css"&gt;\n' + 
				'&nbsp;&lt;!--\n' + 
				'&nbsp;&nbsp;@import url(http://7511742479137856265-a-1802744773732722657-s-sites.googlegroups.com/site/casiopb100/pbDisplay0.1.0.css);\n' +
				'&nbsp;--&gt;\n' + 
				'&lt;\/style&gt;\n' + 
				'&lt;div class="pbDisplay010-Container'+ type +'"&gt;\n' + 
		...
		$("#display_main>span>a").each(function(){
			...
			if(layer0class){
				...
				html += '&nbsp;&nbsp;&nbsp;&lt;span class="'+csr+' '+layer0class+layer0op+'"&gt;'+layer0txt+'&lt;\/span&gt;\n'
			}
			if(layer1class){
				var layer1txt = $("#chr-set ."+layer1class+":eq(0)").attr('title');
				html += '&nbsp;&nbsp;&nbsp;&lt;span class="'+csr+' '+layer1class+layer1op+'"&gt;'+layer1txt+'&lt;\/span&gt;\n'
			}
